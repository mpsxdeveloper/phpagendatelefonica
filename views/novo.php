...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Agenda Telefônica - Novo Contato</title>
    ...
    <body onload="document.getElementById('nome').focus();">
        ...
        <div class="container w-50">
            <form action="add" method="post">
                <h3 class="mt-3">Novo Contato</h3><hr />                
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary float-end">Salvar <i class="fas fa fa-save"></i></button>
            </form>
        </div>
